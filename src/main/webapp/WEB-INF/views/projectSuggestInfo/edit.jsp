				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal"
							...
							<div class="form-group">
								<div class="col-sm-10">
										<h1 align="center">${projectSuggestInfo.suggestTitle}</h1>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-10">
										...
										<h3 align="center">${projectSuggestInfo.accountName}</h3>
										
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-10">
									<h3 align="center">${projectSuggestInfo.suggestContent}</h3>								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-10" align="center">
									${projectDeclareInfo.declareText}
									<fmt:formatDate value="${projectSuggestInfo.createTime}" pattern="yyyy年MM月dd日"/>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
