...
<link href="${ctx}/static/css/plugins/ztree/metroStyle/metroStyle.css" rel="stylesheet">
	<style>
	.ztree li span.button.switch {display:none;}/* å°ztreeææç +/- å¼å³éè */
	</style>

</head>

<body class="gray-bg"> <h3> 页面：test2.jsp <br></h3>
    <div class="wrapper wrapper-content">
        <div class="row">
            ...
            <div class="col-sm-9 animated fadeInRight">
				...
				<div class="box-content" style="overflow:auto;">
     				<ul id="treeView" class="ztree" style="width:100%; overflow:auto;"></ul>
   				</div>
                </div>
            </div>
        </div>
    ...
    <script>
		...
		function addHoverDom(treeId, treeNode) {
		  ...
		  var addStr = "<span class='button add'  title='å¢å èç¹' id='addBtn_" + treeNode.tId + "'></span>";
		  //addStr += "<span class='button remove' title='å é¤èç¹' id='removeBtn_" + treeNode.tId+ "' ></span>";
		  //addStr += "<span class='button edit' title='ç¼è¾' id='editBtn_" + treeNode.tId + "'></span>";
		  sObj.after(addStr);
		...
		var zNodes =[
		 			...
		 			{id:101, pId:1, name:"最简单的树 ", file:"core/standardData"},
		 			{id:102, pId:1, name:"最简单的树 ", file:"core/simpleData"},
	  ...
	  <script>
		...
		$(document).ready(function(){
		  var t = $("#treeView");
		  t = $.fn.zTree.init(t, settingView, zNodesView);
		  //demoIframe = $("#testIframe");
		  //demoIframe.bind("load", loadReady);
		  //var zTree = $.fn.zTree.getZTreeObj("tree");
		  //zTree.selectNode(zTree.getNodeByParam("id", 101));
