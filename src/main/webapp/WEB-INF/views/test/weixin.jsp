      ...
      success: function (res) {
        ...
        geocoder = new qq.maps.Geocoder({
            complete:function(result){
            	//alert(arrayToJson(result));
                alert('国家：'+result.detail.addressComponents.country);
                alert('省份：'+result.detail.addressComponents.province);
                alert('城市：'+result.detail.addressComponents.city);
                alert('区/县：'+result.detail.addressComponents.district);
                alert('详细地址：'+result.detail.address);
            }
        });
