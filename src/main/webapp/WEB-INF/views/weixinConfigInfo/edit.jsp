					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" action="${ctx}/weixinConfigInfo/save" id="form">
						 ...
						 <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<div style="float: left; margin-left: 15px;">
										<p>图片小于2M ( jpg、gif、png)，尺寸为800*800px</p>
							...
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">自动回复</label>
								<div class="col-sm-10">
									<textarea id="description" name="description" class="form-control" style="height: 100px;">${weixinConfigInfo.description}</textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
