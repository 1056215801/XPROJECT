				...
				/* if (result.code == 1 || result.code == 0) { */
					/* for (var i = 0; i < list.length; i++) { */
						...
						var _divList = '<div style="background-color:#fff;margin-bottom: 10px;" onClick="viewClick(this);">'
							+'<div class="publicityTitle" style="text-align:center;">'
							+ info.publicityTitle
							+'</div><div class="publicityContLine" style="border-bottom:1px solid #f14342; display:block; margin:0 10px 0;"></div>'
							+ '<div class="publicityContLine2" style="border-bottom:2px solid #f14342; display:block; margin:1px 10px 0;"></div>'
							+'<div class="publicityCont" style="display:block;margin-top:6px">'
							+ info.publicityText
							+'</div>'
