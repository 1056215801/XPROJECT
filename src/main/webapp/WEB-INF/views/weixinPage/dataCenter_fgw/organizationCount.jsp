...
var optionPart1 = {
		title : {
	        text: '| ${areaInfo.areaName}开发区数量（单位：个）',
	        textStyle:{
	        	color:"#b0e7ff",
	        	fontSize:16,
	        },
...
var optionPart3 = {
		title : {
	        text: '| ${areaInfo.areaName}开发区投产企业数量（单位：个）',
	        textStyle:{
	        	color:"#b0e7ff",
	        	fontSize:16
	        },
	...
	function loadEchart(){
		$.ajax({
			...
			success:function(result){
				...
				optionPart1.title.text="| "+areaName+"开发区数量（单位：个）";
				...
				//part3
				optionPart3.title.text="| "+areaName+"开发区投产企业数量（单位：个）";
