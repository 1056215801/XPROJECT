...
<script type="text/javascript">
	...
	function edit(){
		window.location.href="${ctx}/experienceSharing/weixin/edit?expId=${expShareInfo.expId}";
	}
	
	function publicExp(){
		window.location.href="${ctx}/experienceSharing/weixin/save?expId=${expShareInfo.expId}";
	}
</script>
</head>
<body>
