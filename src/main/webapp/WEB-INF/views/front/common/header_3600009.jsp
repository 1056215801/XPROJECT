...
#thirdMenu .mini-menu p , #firstMenu .mini-menu p{
	margin: 20px 0 30px;
}
.second-menu ul {
	margin-left: 113px;
...
<div class="homePage_head">
		<div class="container head-content">
		    <a href="${urlPath}XOffice/login/gxw">
			<img class="logo fl" src="${ctx}/static/image/homePage_yc/logo_gxw.png" title="江西省工业园区智慧云平台"></a>
 ...
 --%>			<div class="head-user fr">
	...
	<div class="homePage_nav">
		<div class="container nav-content fz0">
			<a href="javascript:;" onclick="toOffice1('/login/gxw')">首页</a>
			<a href="javascript:;" class="industry" id="offices">政务服务</a>
			...
			<a href="${ctx}/helpAsk/allList?entranceId=${entranceId}">帮你问问</a>
		...
		<div class="second-menu" id="firstMenu">
			<div class="container">
				<div class="mini-menu">
					<p>
			...
			<div class="container">
				<div class="mini-menu">
					<p>
						...
						<a  href="${ctx}/yc/list?type=3&entranceId=${entranceId}">用工服务</a>
...
$(function(){
	...
	$("#offices").on("click",function(e){           //二级菜单效果
		 console.log('1')
		 e.stopPropagation();
		 $(this).toggleClass("act");
		 $("#firstMenu").slideToggle("fast").siblings(".second-menu").slideUp("fast");
	 });
...
function showAccount(){
	...
	$("#myWork").click(function(){
		window.open("${ctx}/toXOffice?type=0&path=/admin/application");
	}); 
	doBind();
}
function checkLogin(){
