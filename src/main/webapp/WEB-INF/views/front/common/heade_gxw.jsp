...
<link href="${ctx}/static/css/login/header-fgw.css" rel="stylesheet"/>
	<div class="homePage_head">
		<div class="container head-content">
			...
			<img class="logo" src="${ctx}/static/image/homePage_yc/logo_gxw.png" title="江西省工业园区智慧云平台"></a>
			 <ul class="fr">
				<li><a href="javascript:;" onclick="toOffice('/login/gxw')"><h3>首页</h3><p>HOME PAGE</p></a></li>
				<li><a href="${ctx}/experience/list?entranceId=${entranceId}"><h3>动态</h3><p>INFORMATION</p></a></li>
...
<!-- 									<a onclick="layer.msg('建设中！')" href="javascript:void(0)">公文办理</a>
 -->									<a  href="${ctx}/yc/list?type=1&entranceId=${entranceId}">产业对接月报</a>
								...
								<li>
									...
									<a target="_blank" href="https://www.bjdp2p.com/">金融服务</a>
								</li>
							</ul>
						</div>
					</div>
