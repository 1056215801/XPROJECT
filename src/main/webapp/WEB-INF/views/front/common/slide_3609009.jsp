...
<div class="col-md-3">
	<div class="fir-floor">
		...
		<div class="publish-btn-pic" onclick="picChange()" style="display:none">
			<a href="javascript:;">
				<img alt="" src="${ctx}/static/image/homePage_yc/icon-pic.png" width="25">
				<h1>更改图库</h1>
			</a>
		</div>
	</div>
	...
	<div class="sec-floor" style="background:#fff;height:100%;">
		<div class="reports">
				...
				for(var i=0;i<infoList.length;i++){
					...
					var _div = "";
					 ...
					 var text;
              		...
              		_div += "<a target='_blank' href=\'${ctx}/helpAsk/detail/"+info.askId+"\'>"
              		if(info.askImgUrls){
