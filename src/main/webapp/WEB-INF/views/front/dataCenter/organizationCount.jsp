...
<div class="data_main">
	...
	<input type="hidden" id="nextPageUrl" name="nextPageUrl" value="${ctx}/front/dataCenter/economicCount?orgId=${orgId}&linkId=${linkId}">
	<div class="data_header">
		<img src="${ctx}/static/image/dataCenter/head2.png" width="100%" />
		<img src="${ctx}/static/image/dataCenter/LOGO3.png" width="35%" class="data_logo" />
	</div>
	<div class="data_content">
		...
		<div style="position: absolute; left:25%; bottom:5%; z-index: 100;display: none;" id="backBtn">
...
<c:choose>
	<c:when test="${areaInfo.isProvince}">
		<div class="btn_prev" onclick="window.location.href='${ctx}/front/dataCenter/energyCount?orgId=${orgId}&linkId=${linkId}'"></div>	
	</c:when>
	<c:otherwise>
		<div class="btn_prev" onclick="window.location.href='${ctx}/front/dataCenter/industryCount?orgId=${orgId}&linkId=${linkId}'"></div>	
	</c:otherwise>
</c:choose>
<div class="btn_next" onclick="window.location.href='${ctx}/front/dataCenter/economicCount?orgId=${orgId}&linkId=${linkId}'"></div>
</body>
...
<script type="text/javascript">
	...
	function loadParkEchart(parkData){
		...
		lineOption.title.text=areaName+"工业园区数量（单位：个）";
	...
	function loadCompEchart(compData){
		...
		lineOption.title.text=areaName+"工业园区投产企业数量（单位：个）";
