...
<body>
	...
	<input type="hidden" id="nextPageUrl" name="nextPageUrl" value="${ctx}/front/dataCenter/industryCount?orgId=${orgId}&linkId=${linkId}">
	<div class="data_main">
	...
	<div class="btn_prev" onclick="window.location.href='${ctx}/front/dataCenter/organizationCount?orgId=${orgId}&linkId=${linkId}'"></div>
	<div class="btn_next" onclick="window.location.href='${ctx}/front/dataCenter/industryCount?orgId=${orgId}&linkId=${linkId}'"></div>
</body>
...
<script type="text/javascript">
	...
	var titleIndex = [
		...
		'本月止园区实际开发面积（单位：平方公里）', '出口交货值（单位：亿元）'
	]
	...
	var scrollFunc=function(e){     
	    ...
	    if(e.wheelDelta){//IE/Opera/Chrome     
	        if(e.wheelDelta>0){
	        	window.location.href="${ctx}/front/dataCenter/organizationCount?orgId=${orgId}&linkId=${linkId}";
	        }else{ //向下滚动事件 
