			...
			<div class="col-xs-4">
				<div class="column column-top">
					<div class="tab-title" id="followTab">
						<span class="on">不同材料锂电池装机情况</span>
						<span >关注材料</span>
						<font>2018年10月</font>
					</div>
					<div class="tab">
						...
						<div class="process" id="followTab1" style="display: none;">
							<div style="width: 100%;height: 35px;color:#fff;line-height: 35px;">2018年上半年中国锂电池四大材料出货量</div>
			...
			<div class="col-xs-4">
				<div class="column">
					...
					<div class="tab process-tab">
						...
						<div class="process" id="processTab2" style="display: none;">
...
var type2 = 1;
	...
	function chartholi(){
		...
		var data6 = new Array('1240.36','747.31','4244.07','3000','2500','2400','2300','2394.95','2397.176','2500','2000','2400');
		var data7 = new Array('13183.67','13000','12000','13000','14000','13000','14000','13282.61','15488.17','12000','13000','14000');
		var count = 9;
