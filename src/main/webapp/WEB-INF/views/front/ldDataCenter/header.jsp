...
<link type="text/css" rel="stylesheet" href="${ctx}/static/css/liData/homePage.css"/>
	...
	<div class="head">
		<img class="index-img" onclick="location.href='${ctx}/front/ldDataCenter/index/1'" src="${ctx}/static/image/liData/logo.png">
...
function toLogin(){
	...
	var url;
	if(page==1){
		url = "${ctx}/front/ldDataCenter/index/1"
	}else if(page==2){
		url = "${ctx}/front/ldDataCenter/index/2?type="+type;
	}else if(page==3){
		url = "${ctx}/front/ldDataCenter/index/3?type="+type+'&typeId='+typeId;
	}else if (page==4){
		url = "${ctx}/front/ldDataCenter/index/4?type="+type;
	}else if (page==5){
		url = "${ctx}/front/ldDataCenter/index/5?id="+id+'&typeId='+typeId;;
	}else if (page==6){
		url = "${ctx}/front/ldDataCenter/index/6?type="+type;
	}
	$("#redirectUrl").val(url);
	if(isLogin=='1'){
	 /* 	$('#login').hide();
