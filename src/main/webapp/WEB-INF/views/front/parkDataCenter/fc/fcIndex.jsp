...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/fc_01.png) no-repeat 50% 100%;
    -webkit-background-size: 35%;
    background-size: 35%;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/fc_02.png) no-repeat 50% 100%;
	-webkit-background-size: 35%;
	background-size: 35%;
}
</style>
