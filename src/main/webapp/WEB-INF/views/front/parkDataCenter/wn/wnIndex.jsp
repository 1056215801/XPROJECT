...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/wn_map_01.png) no-repeat 54% 100% fixed;
	background-size: 70%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/wn_map_01.png) no-repeat 54% 100% fixed;
}
.yymain .map-gui img {
    bottom: 55%;
}
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/wn_bg.png) no-repeat 100% 100% ;
	background-size: 100%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/wn_bg.png) no-repeat 100% 100%;
}
.yymain .map-gui img {
    width: 30%;
    left: 45%;
...
.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/wn_map_03.png) no-repeat 54% 100%;
	background-size: 70%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/wn_map_03.png) no-repeat 54% 100%;
}
</style>
</head>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/wn_map_02.png"></div>
