...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/rc_01.png) no-repeat center 120px fixed;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/rc_02.png) no-repeat center 120px;
	-webkit-background-size: 70%;
}
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/rc_03.png"></div>
