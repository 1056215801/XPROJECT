...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/sljk_02.jpg) no-repeat center 70% fixed;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/sljk_02.jpg) no-repeat center 70% fixed;
}
.yymain .map-gui img {
    width: 20%;
    left: 55%;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/sljk_01.jpg) no-repeat center 70% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/sljk_01.jpg) no-repeat center 70% ;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/sljk_03.png) no-repeat center 70% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/sljk_03.png) no-repeat center 70% ;
}
.yymain .chan {
    background-image: url(${ctx}/static/image/parkDataCenter/sljk_06.png);
}
.yymain .chan.on {
    background-image: url(${ctx}/static/image/parkDataCenter/sljk_07.png);
}
.yymain .left-items {
    position: absolute;
    left: 100px;
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="left-items">
			<img height="35px" src="${ctx}/static/image/parkDataCenter/sljk_05.png">
		</div>
		<div class="map1"></div>
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/sljk_04.png"></div>
