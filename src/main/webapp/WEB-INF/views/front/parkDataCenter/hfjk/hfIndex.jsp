...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/hfjk_02.png) no-repeat center 80% fixed;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/hfjk_02.png) no-repeat center 80% fixed;
}
.yymain .map-gui img {
    bottom: 55%;
}
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/hfjk_01.png) no-repeat center 80% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/hfjk_01.png) no-repeat center 80% ;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/hfjk_03.png) no-repeat center 80% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/hfjk_03.png) no-repeat center 80% ;
}
</style>
</head>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/hfjk_04.png"></div>
