...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/js_02.png) no-repeat center 80% fixed;
	background-size: 55%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/js_02.png) no-repeat center 80% fixed;
}
.yymain .map-gui img {
    bottom: 55%;
}
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/js_01.png) no-repeat center 80% ;
	background-size: 55%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/js_01.png) no-repeat center 80% ;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/js_04.png) no-repeat center 80% ;
	background-size: 55%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/js_04.png) no-repeat center 80% ;
}
</style>
</head>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
			<img alt="" height="42px" src="${configInfo.imageUrl}"><!-- ${configInfo.imageUrl} -->
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/js_03.png"></div>
