...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/srjk_02.png) no-repeat center 80% fixed;
	background-size: 35%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/srjk_02.png) no-repeat center 80% fixed;
}
.yymain .map-gui img {
    bottom: 55%;
}
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/srjk_01.png) no-repeat center 80% ;
	background-size: 35%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/srjk_01.png) no-repeat center 80% ;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/srjk_04.png) no-repeat center 80% ;
	background-size: 35%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/srjk_04.png) no-repeat center 80% ;
}
</style>
</head>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/srjk_03.png"></div>
		<div class="map-chan"></div>
		<div class="map-qi" style="width: 60%;height: 60%; background: rgba(0, 0, 0, 0.498039);">
			<div class="chart-title">园区企业总数：<span id="total">0</span>个</div>
