...
<style type="text/css">
.yymain {
	background: url(${ctx}/static/image/parkDataCenter/sg_bg.png) no-repeat center / cover;
	-webkit-background-size: cover;
}
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/sg_01.png) no-repeat center fixed;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/sg_03.png) no-repeat center;
	-webkit-background-size: contain;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/sg_04.png) no-repeat center;
	-webkit-background-size: contain;
}
</style>
</head>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/sg_02.png"></div>
	...
	<div class="btn_prev" onclick="nextPage()"></div>
