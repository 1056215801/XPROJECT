...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/cl_01.png) no-repeat center 80% fixed;
	background-size: 45%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/cl_01.png) no-repeat center 80% fixed;
}
.yymain .map-gui img {
    bottom: 55%;
}
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/cl_03.png) no-repeat center 80% ;
	background-size: 45%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/cl_03.png) no-repeat center 80% ;
}
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/cl_02.png"></div>
