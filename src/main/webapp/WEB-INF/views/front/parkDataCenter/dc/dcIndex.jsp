...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/dc_02.png) no-repeat center fixed;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/dc_01.png) no-repeat center;
	-webkit-background-size: 35%;
	background-size: 35%;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/dc_04.png) no-repeat center;
	-webkit-background-size: 35%;
	background-size: 35%;
}
</style>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><%-- <img alt="" src="${ctx}/static/image/parkDataCenter/dc_03.png"> --%></div>
