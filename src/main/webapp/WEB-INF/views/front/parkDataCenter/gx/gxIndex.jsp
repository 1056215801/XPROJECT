...
<body>
	<div class="yymain bluebg">
		...
		<div class="map-box ay-first">
			<div class="single">
				<img src="${ctx}/static/image/parkDataCenter/gx1.png" data-val='1'>
				<img class="sec" src="${ctx}/static/image/parkDataCenter/gx2.png" data-val='0' style="transition-delay:.25s;">
			</div>
			<div class="double">
...
<script>
	$(function(){
		...
		setTimeout(function(){ $(".single").addClass("on")},100)
