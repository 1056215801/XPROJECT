...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/jx_02.png) no-repeat center fixed;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/jx_01.png) no-repeat center;
	-webkit-background-size: 55%;
	background-size: 55%;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/jx_04.png) no-repeat center;
	-webkit-background-size: 55%;
	background-size: 55%;
}
</style>
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/jx_03.png"></div>
