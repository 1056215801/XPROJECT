...
.yymain .map-gui {
	background: url(${ctx}/static/image/parkDataCenter/ycjk_02.png) no-repeat center 70% fixed;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/ycjk_02.png) no-repeat center 70% fixed;
}
.yymain .map-gui img {
    margin-left: -25%;
    width: 50%;
...
.yymain .map1 {
	...
	width: 100%;
	height: 100%;
	background: url(${ctx}/static/image/parkDataCenter/ycjk_01.png) no-repeat center 70% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/ycjk_01.png) no-repeat center 70% ;
}

.yymain .map-chan {
	background: url(${ctx}/static/image/parkDataCenter/ycjk_03.png) no-repeat center 70% ;
	background-size: 40%;
	-webkit-background: url(${ctx}/static/image/parkDataCenter/ycjk_03.png) no-repeat center 70% ;
}
.yymain .chan {
...
<body>
	...
	<div class="top-bar" style="padding-bottom: 18.5px;padding-top: 18.5px;">
		...
		<div class="map1"></div>
		<div class="map-gui on"><img alt="eight" src="${ctx}/static/image/parkDataCenter/ycjk_04.png"></div>
