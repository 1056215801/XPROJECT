		...
		<div class="project_artical">
			<div class="container main-content">
				<div class="row articals">
					<div class="col-md-12">
						<div class="artical-nav"><p>创建活动</p><a href="${ctx}/helpAsk/allList?entranceId=${entranceId}">返回列表 ></a></div>
...
$(function(){
	...
	function releaseSave(){
		if(validate()){
			var param = {
					...
					activityImage: $("#activityImage").val(),
					start: $("#start").val(),
					end: $("#end").val(),
	...
	function releasePreview(){
		if(validate()){
			$("#editForm1").attr("action","${ctx}/projectActivity/preview");
			$("#editForm1").submit();
		}
	}
	...
	function releaseSuccess(activityId) {
		layer.open({
			...
			content : $('#releaseSuccess'),
				...
				//window.location.href="${ctx}/activity/list?entranceId="+activityId;
				history.go(-1);
			}
		});
	};
