	...
	<div class="project_main">
		...
		<div class="project_content_header">
			<div class="container newNav">
			    ...
			    <div class="newNavSub">
			    	<p class="navTitle">产业对接月报</p>
			    	<p><font class="projectNum" id="projectNum1">0</font>&nbsp;
					<font id="font1">条</font> &nbsp;&nbsp; <font id="font2">产业对接月报</font></p>
			     </div>
			</div>
		</div>
...
$(function(){
	...
	if('${entranceId}'==3600009){
		...
		$(".second-menu li:eq(2) a:eq(1)").addClass("on");
	}else{
		$(".nav-content a:eq(1)").addClass("on");
		$(".second-menu li:eq(2) a:eq(1)").addClass("on");
	}
	$(".source-room a").removeClass("on");
	$(".source-room a:eq(6)").addClass("on")
	getInfoList(1,10,1);
	var msg = '${message}';
	if(msg!=null&&msg!=""){
		tips(msg);
				...
				for(var i=0;i<infoList.length;i++){
					...
					var _div =   '<div class="declareDataBar">'
						...
						if(info.viewUrl){
							...
							_div +='<a target="_blank" href="${ctx}/yc/detail?type=1&id='+info.id+'&entranceId=${entranceId}">'
						}
