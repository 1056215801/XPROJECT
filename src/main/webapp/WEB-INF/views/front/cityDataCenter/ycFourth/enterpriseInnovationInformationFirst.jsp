...
<body class="gray-bg">
	...
	<div class="content fz0">
		<div class="pro-left">
			<ul class="production">
				<li class="first-li" val1="9" val2="index5_code2" val3="企业统计">
					<div class="product-type" id="qytj">企业统计</div>
				</li>
				<li class="first-li on" val1="19" val2="index5_code3" val3="企业创新">
				...
				<div class="nav">	
					<div class="nav-text">
						<div class="tab-eightIndustry" style="margin: 0;">
							<span name="title" class="tabs on">科创平台(<font id="kcpt"></font>)</span>
