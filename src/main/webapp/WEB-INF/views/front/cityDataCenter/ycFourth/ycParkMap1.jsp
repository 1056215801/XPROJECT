        ...
        <div class="eight-main">
           <div class="pro-left">
	         	<ul class="production" style="position: relative;">
					<li class="first-li">
						<div class="product-type" id="product0">主要经济指标</div>
					</li>
					<li class="first-li">
						<div class="product-type" id="product1">工业用电</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product2">区县经济指标</div>
					</li>
					<li class="first-li on"> 
						<div class="product-type" id="product3">园区经济指标</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product4">八大产业</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product5">十大基地</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product6">企业融资</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product7">重点税源企业纳税</div>
					</li>
					<li class="first-li"> 
						<div class="product-type" id="product8">产品价格趋势</div>
					</li>
				</ul>
	         </div>
	         <div class="pro-right">
