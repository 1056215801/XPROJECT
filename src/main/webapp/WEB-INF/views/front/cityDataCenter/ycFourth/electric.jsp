...
<link type="text/css" rel="stylesheet" href="${ctx}/static/css/cityDataCenter/fourthSite.css"/>
...
<body class="gray-bg">
	...
	<div class="content p15 fz0">
		...
		<div class="elec-row">
			<div class="eco-floor">
				<div class="boxStyleBg" onclick="location.href='${ctx}/front/cityDataCenter/ycIndex/3?orgId=3609009'">
					<div class="left-top-radius"></div>
					<div class="left-bottom-radius"></div>
					<div class="right-top-radius"></div>
					<div class="right-bottom-radius"></div>
		...
		$.ajax({
			...
			success : function(result){
				if(result.success){
					...
					$("#total2").rollNum({
				      	deVal: t.AC_GYYDL_PERCENT1.split(".")[0],
				      	digit: t.AC_GYYDL_PERCENT1.split(".")[0].length
				    });
					if(t.AC_GYYDL_PERCENT1.split(".")[1]){
						$("#total3").rollNum({
					      	deVal: t.AC_GYYDL_PERCENT1.split(".")[1],
					      	digit: t.AC_GYYDL_PERCENT1.split(".")[1].length
					    });
					} else {
						$("#total3").rollNum({
					      	deVal: 0,
					...
					$("#t2").rollNum({
				      	deVal: t.US_GYYDL_PERCENT1.split(".")[0],
				      	digit: t.US_GYYDL_PERCENT1.split(".")[0].length
				    });
					if(t.AC_GYYDL_PERCENT1.split(".")[1]){
						$("#t3").rollNum({
					      	deVal: t.US_GYYDL_PERCENT1.split(".")[1],
					      	digit: t.US_GYYDL_PERCENT1.split(".")[1].length
					    });
					} else {
						$("#t3").rollNum({
					      	deVal: 0,
