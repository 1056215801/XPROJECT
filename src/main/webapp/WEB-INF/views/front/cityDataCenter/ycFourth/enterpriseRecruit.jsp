...
<body class="gray-bg">
	...
	<div class="content fz0">
		<div class="pro-left">
			<ul class="production">
				<li class="first-li" val1="6" val2="index4_code2" val3="物流服务">
					<div class="product-type" >物流服务</div>
				</li>
				<li class="first-li on" val1="18" val2="index4_code3" val3="用工分析">
				...
				<div class="spanStyle" style="width: 25%;">
					<div class="blockStyle" style="height: 50%;">
						<div class="outsideBox">
							...
							<div class="tabCaptionBar">
								<span class="tabCaption">园区招聘统计</span>
					...
					<div class="blockStyle" style="height: calc(50% - 10px);">
						<div class="outsideBox">
							...
							<img class="corner rb" src="${ctx}/static/image/cityDataCenter/jxNew/rb.png">
							<div class="tabCaptionBar">
								<span class="tabCaption">企业招聘统计</span>
								<span class="fr" style="color: #fff;border: 0;padding: 0;margin: 0; margin-right: 10px;">数量</span>
							</div>
							<div class="tabContBar">
								<div  class="tabs">
				...
				<div class="spanStyle" style="width: calc(25% - 10px);">
					<div class="blockStyle" style="height: 50%;">
						<div class="outsideBox">
							...
							<img class="corner rb" src="${ctx}/static/image/cityDataCenter/jxNew/rb.png">
							<div class="tabCaptionBar">
								<span class="tabCaption" style="width: 100%;">本月用工需求分析</span>
							</div>
							<div class="tabContBar">
					...
					<div class="blockStyle" style="height: calc(50% - 10px);">
						<div class="outsideBox">
							...
							<img class="corner lb" src="${ctx}/static/image/cityDataCenter/jxNew/lb.png">
							<img class="corner rb" src="${ctx}/static/image/cityDataCenter/jxNew/rb.png">
							<div class="tabCaptionBar tab-links" id="firstTab">
