...
.index-link {
	...
	<div class="head">
	   ...
	   <div class="tab">
	   		<a class="goBack-a" onclick="location.href='${ctx}/front/cityDataCenter/lcIndex/1'"><img src="${ctx}/static/image/cityDataCenter/ycNew2/goBack.png" style="margin-right:5px;"><span>返回首页<span></a>
	      	<a href="javascript:;"  class="head-a on" id="head1-a">园区安防管理</a>
      	  	<a href="javascript:;" class="head-a" id="head2-a" onclick="layer.msg('内容建设中...')">生产线可视化</a>
			<a href="javascript:;" class="head-a" onclick="layer.msg('内容建设中...')">服务效能</a>
	   </div>
