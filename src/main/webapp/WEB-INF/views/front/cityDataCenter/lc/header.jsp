...
.head {
    position: relative;
    height: 90px;
  	background: url(${ctx}/static/image/cityDataCenter/lc/lclogo.png) no-repeat center;
...
.index-link {
	...
	<div class="head">
   		<a href="${ctx}/front/cityDataCenter/lcIndex/8" class="index-link"></a>
	   	<div class="tab">
	      	<a href="${ctx}/front/cityDataCenter/lcIndex/1" class="head-a">首页</a>
      	  	<a href="${ctx}/front/cityDataCenter/lcIndex/2?companyId=90020190620124555360171000000002" class="head-a">企业画像</a>
			<a href="${ctx}/front/cityDataCenter/lcIndex/3" class="head-a">运营管理</a>
			<a href="${ctx}/front/cityDataCenter/lcIndex/4" class="head-a">工业投资</a>
			<a href="${ctx}/front/cityDataCenter/lcIndex/5" class="head-a">生产监测</a>
			<a href="${ctx}/front/cityDataCenter/lcIndex/6" class="head-a">基础设施</a>
			<a href="${ctx}/front/cityDataCenter/lcIndex/7" class="head-a">应急指挥</a>
	   	</div>
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/lcIndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
...
function toLogin(){
	...
	var url  = "";
	if(page==2){
		var url = "${ctx}/front/cityDataCenter/lcIndex/2?companyId=90020190620124555360171000000002";
	}else{
	  url = "${ctx}/front/cityDataCenter/lcIndex/"+page;
	}
	$("#redirectUrl").val(url);
	if(isLogin=='1'){
	 /* 	$('#login').hide();
