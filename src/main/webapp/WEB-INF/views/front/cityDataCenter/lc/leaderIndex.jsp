...
<div class="homePageBar">
	...
	<img class="cf-logo" src="${ctx}/static/image/cityDataCenter/lc/logo-lc.png">
...
<script>
    ...
    function toZHGY(){
       	window.location.href = "${OfficeUrl}XOffice/login/lc"; 
    }
    function toZHFW(){
 		window.location.href = "${OfficeUrl}springBoot/site/1262";
    }
    function toGYDSJ(){
    	window.open("${OfficeUrl}XProject/front/cityDataCenter/lcIndex/1","_blank");
    }
</script>
</body>
</html>