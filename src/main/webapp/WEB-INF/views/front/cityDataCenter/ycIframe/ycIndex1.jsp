			...
			<div class="dataChart_box">
				...
				<div class="chart_box2">
					<div class="dataBar_3_left" id="sortListdiv" style="background-color:#fff;color: #000;">
						...
						<table class="table table-striped table-hover" id="sortList"style="height: 380px;"></table>
					</div>
...
<script type="text/javascript">
	...
	function table(){
		...
		window.location.href="${ctx}/front/cityDataCenter/indexIframe/3?orgId=${orgId}&areaId="+areaId;
	}
	...
	function loadData2() {
		...
		$.get('${ctx}/static/map/360900.json', function(chinaJson) {
			...
			mapChart.on('click', function (param) {
		        ...
		        if(flag){
			     	window.location.href="${ctx}/front/cityDataCenter/indexIframe/2?"
			     			+"orgId=${orgId}&areaId="+cityMap[cityName];
		        }
