...
.head {
    position: relative;
    height: 90px;
  	background: url(${ctx}/static/image/cityDataCenter/jgs/head.png) no-repeat center;
 ...
 .head-a {
  ...
  .accountName {margin-right: 0px; }
	...
	<div class="head">
	   ...
	   <div class="tab">
	      	<a href="${ctx}/front/cityDataCenter/jgsIndex/1" class="head-a">首页</a>
      	  	<a href="${ctx}/front/cityDataCenter/jgsIndex/2?companyId=2016052609383280800263" class="head-a">企业画像</a>
			<a href="${ctx}/front/cityDataCenter/jgsIndex/3" class="head-a">运营管理</a>
			<a href="${ctx}/front/cityDataCenter/jgsIndex/4" class="head-a">工业投资</a>
			<a href="${ctx}/front/cityDataCenter/jgsIndex/5" class="head-a">生产监测</a>
			<a href="${ctx}/front/cityDataCenter/jgsIndex/6" class="head-a">基础设施</a>
			<a href="${ctx}/front/cityDataCenter/jgsIndex/7" class="head-a">应急指挥</a>
	   </div>
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/jgsIndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
...
function toLogin(){
	...
	var url  = "";
	if(page==2){
		var url = "${ctx}/front/cityDataCenter/jgsIndex/2?companyId=2016052609383280800263";
	}else{
	  url = "${ctx}/front/cityDataCenter/jgsIndex/"+page;
	}
	$("#redirectUrl").val(url);
	if(isLogin=='1'){
	 /* 	$('#login').hide();
