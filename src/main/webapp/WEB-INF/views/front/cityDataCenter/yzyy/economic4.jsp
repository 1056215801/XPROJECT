...
$(function(){
	...
	$('.yzyyLegend span').on("click",function(){
		...
		if($(this).parent().attr('id')=='legend1'){
			...
			yzyyData2(historyData2.rjxsczValue1,historyData2.rjxsczValue2,'产值（万元）','同比','div2-map2',2,'产值','同比','万元','%',legend,2,1);
			...
			yzyyData2(historyData2.dwcznhValue1,historyData2.dwcznhValue2,'能耗（万度/万元）','同比','div2-map3',2,'能耗','同比','（度/万元）','%',legend,2,1);
		}
	});
})
