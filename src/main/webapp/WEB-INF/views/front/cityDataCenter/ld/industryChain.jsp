...
<body class="gray-bg">
	...
	<div class="container-fluid content2 container-fluid-new">
		<div class="main">
			<div class="pro-left">
				<ul class="production price-production industry-production" id="production">
					<li class="first-li on">
						<div class="product-type">发展情况<i class="fa  fa-angle-right"></i></div>
					...
					<li class="first-li">
						<div class="product-type">国内外优秀企业<i class="fa fa-angle-right"></i></div>
						<ul class="product-item">
