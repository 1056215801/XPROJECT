...
<body class="gray-bg">
	...
	<div class="mainpage clear-box">
		...
		<div class="logis-main mainfl" style="width: 25%;">
			   <div class="boxStyle carTopBox serviceBox">
				<div class="boxStyleBg">
					...
					<div class="boxTit">
						<span onclick="goLogistics()">物流服务</span>
					</div>
	         ...
	         <div class="boxStyle carTopBox serviceBox">
				<div class="boxStyleBg">
					...
					<div class="left-line"></div>
					<div class="right-line"></div>
					<div class="tab-links" style="text-align: center;position: relative; cursor: pointer;"">
						<span class="on" onclick="toRecruit()">本月用工需求分析</span>
						...
						<div class="selects" style="display: inline-block;">
							<div class="select" style="padding: 0 8px;">
								...
								<div class="select-items">
									<ul id="sm" style="text-align: left;max-height: 210px !important;">
										<li>1月</li>
										<li>2月</li>
										<li>3月</li>
										<li>4月</li>
		...
		<div class="logis-main mainfl" style="width:25%;">
	        <div class="boxStyle carTopBox serviceBox logistics-Box">
				<div class="boxStyleBg">
					<div class="left-top-radius"></div>
					<div class="left-bottom-radius"></div>
					<div class="right-top-radius"></div>
					...
					<div class="right-line"></div>
					<div class="boxTit">
						<span onclick='goPage("${ctx}/front/cityDataCenter/ycIndex/10?orgId=3609009")'>企业帮扶</span>
					</div>
					<div class="help-main">
						<div class="help-title fz0 logistics-item" onclick='goPage("${ctx}/front/cityDataCenter/ycIndex/10?orgId=3609009")'>
						...
						<div class="helpMap" id="helpMap">
						
						</div>
					</div>
				</div>
	        </div>
        	<div class="boxStyle carTopBox serviceBox" style="padding: 10px 15px;">
				<div class="boxStyleBg">
					<div class="left-top-radius"></div>
					<div class="left-bottom-radius"></div>
					<div class="right-top-radius"></div>
					...
					<div class="serviceDisplayBar">
						<div class="serviceDisplay">
							...
							<div class="serviceCont">
								<div class="serviceContBox" id="hp">
									...
									<div class="serviceContValue"><i></i><span>263</span></div>
								</div>
								<div class="serviceContBox" id="hpzj">
									<div class="serviceContName">获批资金(亿元)</div>
									<div class="serviceContValue"><i></i><span>3.77</span></div>
								</div>
						...
						<div class="serviceDisplay">
							<div class="serviceTitle">标准厂房 - 2018</div>
							<div class="serviceCont">
								<div class="serviceContBox" id="qn">
									<div class="serviceContName">全年合计(m^2)</div>
									<div class="serviceContValue"><i></i><span>266.6</span><font>万</font></div>
								</div>
								<div class="serviceContBox" id="zt">
									<div class="serviceContName">主体竣工(m^2)</div>
									<div class="serviceContValue"><i></i><span>109.1</span><font>万</font></div>
								</div>
								<div class="serviceContBox" id="zj">
									<div class="serviceContName">在建(m^2)</div>
									<div class="serviceContValue"><i></i><span>157.5</span><font>万</font></div>
								</div>
							</div>
						</div>
					</div>
...
function goLogistics(){
	goPage("${ctx}/front/cityDataCenter/ycIndex/6?orgId=3609009");
}
function toRecruit(){
	goPage("${ctx}/front/cityDataCenter/ycIndex/18?orgId=3609009");
}
...
function barChart(){
	...
	if($("#qn").hasClass("on")){
		barOption.series[0].data = ["34","4","0","46.2","7","21.3","15.3","14","30.6","48.6","50"];
	}else if($("#zt").hasClass("on")){
		barOption.series[0].data = ["19","2","0","22","0","0","0","14","14","12.1","26"];
	}else if($("#zj").hasClass("on")){
		barOption.series[0].data = ["15","2","0","24.2","7","21.3","15.3","0","16.6","32.1","24"];
	}else{}
