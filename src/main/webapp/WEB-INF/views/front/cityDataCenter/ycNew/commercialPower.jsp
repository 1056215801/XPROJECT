...
<body class="gray-bg">
	...
	<div class="nav-title">
    	<div class="nav">
		    ...
		    <div class="return" onclick="location.href='${ctx}/front/cityDataCenter/ycIndex/14?orgId=3609009'"><img src="${ctx}/static/image/liData/back.png"><font>返回实时用电</font></div>
		</div> 
    </div>
