...
var isHidden = true;  //第二个tab的echart初始化显示，之后要隐藏，但是只有初始化要隐藏
	...
	function goSeven(){
		goPage("${ctx}/front/cityDataCenter/ycIndex/7?orgId=3609009"+'&spanIndex='+$("#spanIndex").val());
	}
	function goTen(){
		goPage("${ctx}/front/cityDataCenter/ycIndex/8?orgId=3609009"+'&spanIndex='+$("#spanIndex").val());
	}
	function goElectric(){
		goPage("${ctx}/front/cityDataCenter/ycIndex/3?orgId=3609009");
	}
	function goEconomic(){
		goPage("${ctx}/front/cityDataCenter/ycIndex/2?orgId=3609009");
	}
</script>
</html>
