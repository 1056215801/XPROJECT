...
<body class="gray-bg">
	...
	<div class="drawHeader">
		<img src="${ctx}/static/image/cityDataCenter/jxNew/qyhx.png">
	</div>
...
<script type="text/javascript">
	$(function(){
		if(showWindowHref().companyId != "" && showWindowHref().companyId != undefined){
			$("#companyId").val(showWindowHref().companyId);
		}
