				...
				<div class="outsideBox">
					...
					<div class="industryDataBar">
						<div class="selects" style="position: absolute; top: 3px; right: -7px;">
							...
							<div class="selects" style="display: inline-block;">
								<div class="select">
									<p><font id="selectQuarter">季度</font><i class="fa fa-caret-down"></i></p>
									<div class="select-items">
										<ul id="sq">
											<li value="1">一季度</li>
											<li value="2">二季度</li>
		...
		<div class="logis-main maincenter" style="width: 50%;">
			<div class="boxStyle" style="height: 66.66%;">
				...
				<div class="map-areas" style="top: 40px;left: 20px;">
					<span style="cursor: pointer;" onclick="goPage('${ctx}/front/cityDataCenter/gxwIndex/23')">
						<h4>江西省</h4>
					</span>
		...
		<div class="logis-main mainfr">
	        <div class="boxStyle carTopBox" style="height: 66.66%;">
				<div class="outsideBox">
					...
					<img class="corner rb" src="${ctx}/static/image/cityDataCenter/jxNew/rb.png">
					<div class="tabCaptionBar" onclick="toSecondPage()" style="cursor: pointer;">
						<span class="tabCaption">10亿元以上项目</span>
					</div>
					<div class="tabContBar">
	        ...
	        <div class="boxStyle orderTableBox" style="margin-top: 10px; cursor: pointer;">
				<div class="outsideBox">
					<img class="corner lt" src="${ctx}/static/image/cityDataCenter/jxNew/lt.png">
					<img class="corner rt" src="${ctx}/static/image/cityDataCenter/jxNew/rt.png">
					<img class="corner lb" src="${ctx}/static/image/cityDataCenter/jxNew/lb.png">
...
function toSecondPage(){
	goPage("${ctx}/front/cityDataCenter/gxwIndex/15");
}
/**
 * type 1:字符串 0:数字
 */
    ...
    myChart.on('click', function(param){
    	if(param.seriesIndex == 0){//点击区块
    		...
    		if($("#orgId").val() == param.data.value){
				...
				$(".map-areas span:eq(2)").addClass("on").find("h4").text(param.data.name);
			}
