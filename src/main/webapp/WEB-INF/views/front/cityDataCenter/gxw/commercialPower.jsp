    	...
    	<div class="nav">
			<div class="nav-text">
				...
				<div class="nav-tabName" id="index">
				   	...
				   	<span id="ycsgxq" name="title"  data="" style="display: none;">宜春市各县区</span>
		    ...
		    <div class="return" onclick="location.href='${ctx}/front/cityDataCenter/gxwIndex/14?orgId=3609009'"><img src="${ctx}/static/image/liData/back.png"><font>返回实时用电</font></div>
		</div> 
    </div>
	<div class="container-fluid power-content">
		<div class="content-tab" id="tab1">
					...
					<div class="module-content">
						<div class="state_header">
							...
							<div class="selects" style="display: inline-block; vertical-align: middle;">
								<div class="select" style="font-size: 18px;">
									<p>江西省</p><!-- <i class="fa fa-caret-down"></i> -->
									<!-- <ul>
										<li></li>
									</ul> -->
								</div>
						...
						<div class="electricDataBar">
							<div class="electricDataFlex">
								...
								<div class="electricData">
									<div>
										<div class="electricTitle">增幅全国排名</div>
										<div class="electricValue blueT"><font id="ydRanking">0</font>名</div>
									</div>
								</div>
							</div>
						</div>
						<div class="electricChartBar">
							<div class="tab-links" style="display: inline-block;position: absolute; top: 0; left: 0; z-index: 10;">
								<span class="on">江西省<font id="ydYear">2018</font>年<font id="ydBarType">工业用电</font>情况(单位：万千瓦时)</span>
							</div>
			...
			<div class="floor_h45">
				<div class="module-down">
					<div id="piePicture" class="module-content">
						<div class="tab-links">
							<span class="on">江西省<font id="ydPieStatistics">本月</font>用电占比统计(单位：万千瓦时)</span>
						</div>
						<div class="pieTitle">
					...
					<div id="ratioPicture" class="module-content" style="display: none;">
						<div class="tab-links">
							<span class="on">江西制造业占工业用电比统计</span>
						</div>
		...
		success : function(result) {
			...
			if (result.success) {
				...
				if(barData != null && barData !='' && barData != '[]'){
					var _div = '<tr><th>江西省</th><th>1月</th><th>2月</th><th>3月</th><th>4月</th><th>5月</th><th>6月</th><th>7月</th><th>8月</th><th>9月</th><th>10月</th><th>11月</th><th>12月</th></tr>';
						_div += '<tr>';
							_div += '<td>占比</td>';
						for(var i=0;i<12;i++){
							var info = barData[i];
	...
	if($("#cityGy").hasClass("on")){
		...
		if(type == 1){
			...
			for(var m=0; m<seriesRatioUs[0].length; m++){
				...
				percentArr1.push(Number(percent)+Number(0.0000001*m));
				percentArr2.push(Number(percent)+Number(0.0000001*m));
				if(percent!=''){				
			...
			percentArr2.sort(sortNum);
			var order = [];
			for(var i=0;i<percentArr1.length;i++){
				for(var j=0;j<percentArr2.length;j++){
					if(Number(percentArr1[i])==Number(percentArr2[j])){
						order.push(percentArr2.length-j);
					}
				}
			}
			var tr2 = '<tr><td>排名</td>';
