...
<div class="homePageBar">
    ...
    <div class="guidanceCompany">指导单位：宜春市工信委</div>
...
var isLogin = '${isLogin}';
    	...
    	$("#loginBt").click(function(){
    	 ...
    	 //   $("form").submit();
    	    ...
    	    if(redirectUrl==null || redirectUrl=='' ){
    			redirectUrl="${ctx}/front/cityDataCenter/ycIndex/11" ;
    		} 
    	    goMain(redirectUrl);
    	    return false;
    	});	
    ...
    function toGYDSJ(){
    	//window.location.href = "${OfficeUrl}/XProject/front/cityDataCenter/ycIndex/1?orgId=3609009";
    	window.location.href = "${OfficeUrl}XProject/front/cityDataCenter/ycIndex/13?orgId=3609009"
    }
   /*  function toLDDSJ(){
    	window.location.href = "${OfficeUrl}XProject/front/cityDataCenter/ycLdIndex/1";  //新版锂电
    }  */
    function toLDDSJ(){
    	window.location.href = "${OfficeUrl}XProject/front/ldDataCenter/index/1";
    }
    function getNow() {
        var date = new Date();
 ...
 function toLogin(){
    	...
    	var url = "${ctx}/front/cityDataCenter/ycIndex/11";
    	$("#redirectUrl").val(url);
    	if(isLogin=='1'){
    	 /* 	$('#login').hide();
    		$('#nologin').show();  */
