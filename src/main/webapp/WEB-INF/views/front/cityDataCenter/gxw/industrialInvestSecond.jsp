...
<body class="gray-bg">
	...
	<div class="mainpage clear-box">
		<div class="projectIndexBar">
			...
			<a class="goBack-a" onclick="location.href='${ctx}/front/cityDataCenter/gxwIndex/12'"><img src="${ctx}/static/image/cityDataCenter/ycNew2/goBack.png" style="margin-right:5px;"><span>返回首页<span></a>
		</div>
		...
		<div class="logis-main" style="width: calc(20% - 10px); height: 100%; margin-left: 10px; font-size: 0;">
			<div class="boxStyle" style="width: 100%; height: calc(50% - 35px); margin-top: 70px;">
				<div class="outsideBox">
					<img class="corner lt" src="${ctx}/static/image/cityDataCenter/jxNew/lt.png">
					<img class="corner rt" src="${ctx}/static/image/cityDataCenter/jxNew/rt.png">
					<img class="corner lb" src="${ctx}/static/image/cityDataCenter/jxNew/lb.png">
...
function goDetail(url){
	if(isLogin=='1'){ 
		...
		goPage("${ctx}/front/cityDataCenter/gxwIndex/15?orgId=3609009")
	}
}
