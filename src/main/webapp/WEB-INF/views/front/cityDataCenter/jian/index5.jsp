...
<div class="homePageBar">
	...
	<img class="cf-logo" src="${ctx}/static/image/cityDataCenter/jian/logo-ja.png">
...
<script>
    ...
    function toZHGY(){
       	window.location.href = "${OfficeUrl}XOffice/login/jian"; 
    }
    function toZHFW(){
 		window.location.href = "${OfficeUrl}springBoot/site/1245";
    }
    function toGYDSJ(){
    	window.open("${OfficeUrl}XProject/front/cityDataCenter/jianIndex/1","_blank");
    }
</script>
</body>
</html>