...
<body class="gray-bg bg5">
	<div class="head">
        ...
        <div class="tab">
            ...
            <a href="javascript:;" class="head-a head-a2 on">园区安防管理</a>
            <a href="javascript:alert('建设中...');" class="head-a head-a2">生产线可视化</a>
            <a href="javascript:alert('建设中...');" class="head-a">服务效能</a>
        </div>
    ...
    <div class="content scjc" id="content">
    </div>
</body>
