...
<div class="homePageBar">
    ...
    <div class="homePageLogo">
        <img src="${ctx}/static/image/cityDataCenter/leaderIndex/logo_qn.png" width="40%">
    </div>
        ...
        <div class="homePageCont">
            ...
            <div class="projectLeftBar">
                <div class="leftSphere" onclick="toZHGY()">
                    <img src="${ctx}/static/image/cityDataCenter/leaderIndex/gydsjBar.png" id="zhgyBar">
    ...
    <div class="guidanceCompany">指导单位：全南县工业和信息化局</div>
