...
<body class="gray-bg bg6">
	<div class="head">
        ...
        <div class="tab">
            ...
            <a href="javascript:;" class="head-a head-a2 on">园区网格化</a>
            <a href="javascript:alert('建设中...');" class="head-a">园区管网</a>
            <a href="javascript:alert('建设中...');" class="head-a">智能楼宇</a>
            <a href="javascript:alert('建设中...');" class="head-a">IT运维</a>
        </div>
    ...
    <div class="content jcss" id="content">
    </div>
</body>
