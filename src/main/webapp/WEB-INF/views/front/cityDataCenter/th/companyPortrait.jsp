...
<script type="text/javascript">
	...
	function goIndex(index){
		if(index==1){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/1';
		}else if(index==2){
			
		}else if(index==3){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/3';
		}else if (index==4){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/4';
		}else if(index==5){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/5';
		}else if (index==6){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/6';
		}else if(index==7){
			window.location.href= '${ctx}/front/cityDataCenter/thIndex/7';
		}
	...
	function choiceCompany(){
		layer.open({
			...
			shade: 0.3,
			area: ['900px', '675px'],
			content: '${ctx}/front/page/companyInfo/frame?parkId=1251&treeType=park' //iframe的url
		}); 
	};
