...
.head {
    position: relative;
    height: 90px;
  	background: url(${ctx}/static/image/cityDataCenter/th/headNew.png) no-repeat center;
...
@media screen and (max-width: 1366px){
 .head-a {
  ...
  .accountName {margin-right: 0px; }
	...
	<div class="head">
	   <div class="tab">
	      	<a href="${ctx}/front/cityDataCenter/thIndex/1" class="head-a">首页</a>
      	  	<a href="${ctx}/front/cityDataCenter/thIndex/2?companyId=90020170725184849002118000000026" class="head-a">企业画像</a>
			<a href="${ctx}/front/cityDataCenter/thIndex/3" class="head-a">运营管理</a>
			<a href="${ctx}/front/cityDataCenter/thIndex/4" class="head-a">工业投资</a>
			<a href="${ctx}/front/cityDataCenter/thIndex/5" class="head-a">生产监测</a>
			<a href="${ctx}/front/cityDataCenter/thIndex/6" class="head-a">基础设施</a>
			<a href="${ctx}/front/cityDataCenter/thIndex/7" class="head-a">应急指挥</a>
	   </div>
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/thIndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
...
function toLogin(){
	...
	var url  = "";
	if(page==2){
		var url = "${ctx}/front/cityDataCenter/thIndex/2?companyId=90020170725184849002118000000026";
	}else{
	  url = "${ctx}/front/cityDataCenter/thIndex/"+page;
	}
	$("#redirectUrl").val(url);
	if(isLogin=='1'){
	 /* 	$('#login').hide();
