 ...
 .head-a {
  ...
  .accountName {margin-right: 0px; }
	...
	<div class="head">
	   ...
	   <div class="tab">
	   		<a class="goBack-a" onclick="location.href='${ctx}/front/cityDataCenter/jxIndex/1'"><img src="${ctx}/static/image/cityDataCenter/ycNew2/goBack.png" style="margin-right:5px;"><span>返回首页<span></a>
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/jgsndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
