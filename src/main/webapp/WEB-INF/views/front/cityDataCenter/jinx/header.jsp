...
.head {
    position: relative;
    height: 90px;
	background: url(${ctx}/static/image/cityDataCenter/jinx/head.png) no-repeat center bottom;
...
.head-a.on {
	color: #FFE42D;
	background: url(${ctx}/static/image/cityDataCenter/jinx/cl2.png) no-repeat center;
...
@media screen and (max-width: 1366px){
 .head-a {
  ...
  .accountName {margin-right: 0px; }
	...
	<div class="head">
		<img class="index-img" onclick="location.href='${ctx}/front/cityDataCenter/jxIndex/13'" src="${ctx}/static/image/cityDataCenter/jinx/logo.png">
		<a href="${ctx}/front/cityDataCenter/jxIndex/1" class="head-a">产业全景</a>
		<a href="${ctx}/front/cityDataCenter/jxIndex/2?companyId=201611220119148080182" class="head-a">企业画像</a>
		<a href="${ctx}/front/cityDataCenter/jxIndex/3" class="head-a">企业服务</a>
		<a href="${ctx}/front/cityDataCenter/jxIndex/4" class="head-a">工业投资</a>
		<a href="${ctx}/front/cityDataCenter/jxIndex/5" class="head-a">标准厂房</a>
		<a href="${ctx}/front/cityDataCenter/jxIndex/6" class="head-a">招商引资</a>
		<div class="time">
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/jxIndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
...
function toLogin(){
	...
	var url  = "";
	if(page==2){
		var url = "${ctx}/front/cityDataCenter/jxIndex/2?companyId=2016052609383280800263";
	}else{
	  url = "${ctx}/front/cityDataCenter/jxIndex/"+page;
	}
	$("#redirectUrl").val(url);
	if(isLogin=='1'){
	 /* 	$('#login').hide();
