...
<script>
	...
	function chart(){
		var year = $("#year").val();
		var month = $("#month").val();
		window.location.href="${ctx}/front/cityDataCenter/index/4?orgId=${orgId}&areaId=${areaId}&year="+year+"&month="+month;
	}
			...
			success : function(result) {
				if (result.success) {
					...
					if(econList.length == 0){
						...
						var tr = '<tr><td colspan="15">'+msg+'</td></tr>';
						$("#econData").append(tr);
