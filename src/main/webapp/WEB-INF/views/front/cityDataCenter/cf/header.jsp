...
.index-link {
	...
	<div class="head">
	   	...
	   	<div class="tab">
	      	<a href="${ctx}/front/cityDataCenter/cfIndex/1" class="head-a">首页</a>
      	  	<a href="${ctx}/front/cityDataCenter/cfIndex/2?companyId=90020170725184849002118000000026" class="head-a">企业画像</a>
			<a href="${ctx}/front/cityDataCenter/cfIndex/3" class="head-a">运营管理</a>
			<a href="${ctx}/front/cityDataCenter/cfIndex/4" class="head-a">工业投资</a>
			<a href="${ctx}/front/cityDataCenter/cfIndex/5" class="head-a">生产监测</a>
			<a href="${ctx}/front/cityDataCenter/cfIndex/6" class="head-a">基础设施</a>
			<a href="${ctx}/front/cityDataCenter/cfIndex/7" class="head-a">应急指挥</a>
	   	</div>
	...
	$("#loginBt").click(function(){
	 ...
	 //   $("form").submit();
	    ...
	    if(redirectUrl==null || redirectUrl=='' ){
			redirectUrl="${ctx}/front/cityDataCenter/cfIndex/1" ;
		} 
	    goMain(redirectUrl);
	    return false;
	});	
...
function toLogin(){
	...
	var url  = "";
	if(page==2){
		var url = "${ctx}/front/cityDataCenter/cfIndex/2?companyId=2016052609383280800263";
	}else{
