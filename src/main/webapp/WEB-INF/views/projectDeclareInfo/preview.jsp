					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal"
							action="${ctx}/projectDeclareInfo/save" id="form">
                         	<input type="hidden" id="declareId" name="declareId" value="${projectDeclareInfo.declareId}" />
							...
							<div class="form-group">
								...
								<input id="editBtn" class="btn btn-white" type="button" value="再次编辑" />
								</div>
							</div>
						</form>
					</div>
    ...
    <script>
		$(function() {
			...
			$('#saveBtn').click(function(){
				window.location.href="${ctx}/projectDeclareApply/save";
			});
			$('#editBtn').click(function(){
				window.location.href="${ctx}/projectDeclareInfo/edit?declareId=${projectDeclareInfo.declareId}";
			});
