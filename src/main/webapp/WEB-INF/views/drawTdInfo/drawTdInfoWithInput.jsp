				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							<!-- <button class="btn btn-primary btn btn-white" id="saveBtn">保存</button> -->
					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" action="${ctx}/drawTdInfo/save" id="form">
							<input type="hidden" name="tableId" value="${drawTdInfo.tableId}"/>
								...
								<c:forEach begin="1" end="${drawTableInfo.rowNum}" step="1" var="r">
									...
									<c:forEach items="${tdList}" var="td">
										<c:if test="${td.rowNum == r}">
											<td class="td dropSpan" rowspan="${td.rowspanNum}" colspan="${td.colspanNum}" onselect="return false;" id="${td.tdNo}"  onclick="tdck(this)">
