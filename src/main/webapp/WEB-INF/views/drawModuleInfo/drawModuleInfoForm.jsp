			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" action="${ctx}/drawModuleInfo/save" id="form">
							<input name="pageNum" value="${pageNum}" type="hidden">
							<input name="id" value="${drawModuleInfo.id}" type="hidden">
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">名称</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="moduleName" value="${drawModuleInfo.moduleName}" 
										placeholder="请输入模块名称" />
								</div>
							</div>
							...
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">唯一标识(后台开发)</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="uniqueMark" value="${drawModuleInfo.uniqueMark}" 
										placeholder="请输入唯一标识" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="modelType" id="modelType" class="form-control">
										<c:if test="${drawModuleInfo.modelType=='1'}">
										<option value="1">模块</option>
										</c:if>
										
										<c:if test="${drawModuleInfo.modelType=='2'}">
										<option value="2">组别</option>
										</c:if>
										
										<c:if test="${drawModuleInfo.modelType=='3'}">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea id="description" name="description" placeholder="请输入相关描述" class="form-control" style="height: 100px;">${drawModuleInfo.description}</textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="sortGrade" value="${drawModuleInfo.sortGrade}" 
										placeholder="请输入排序号，序号越小越靠前，可以为空" />
								</div>
							</div>
	...
	<script>
		$(function() {
			...
			$("#cancelBtn").click(function() {
				//$("#form").attr("action","${ctx}/drawModuleInfo/list").submit();
				window.history.go(-1);
				return false;
			});
		});
