package com.chinatelecom.jx.zone.management.weixin.menu;
...
public class MenuManager  {
	 public static void main(String[] args) { 
		   ...
		   // 将菜单对象转换成json字符串
		   //有问题：主菜单项多了一个type
		   String jsonMenu = JsonKit.toJson(m.getTestMenus()).toString();
...
//	       System.out.println(apiResult.getJson());
	    ...
	    public   Menu getTestMenus() {  
	        ...
	        btn33.setName("在线咨询");  
	        btn33.setType("view");  
	        btn33.setUrl("http://wpa.qq.com/msgrd?v=3&uin=7828752&site=qq&menu=yes");  
