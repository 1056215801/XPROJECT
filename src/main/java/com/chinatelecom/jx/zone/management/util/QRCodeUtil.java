...
public class QRCodeUtil {
	...
	private static BufferedImage createImage(String content, String logoPath, boolean needCompress) throws IOException, WriterException {
		...
		if (!org.apache.commons.lang3.StringUtils.isEmpty(logoPath)) {// 是否插入Logo图片
	...
	private static void insertImage(BufferedImage source, String logoPath, boolean needCompress) throws IOException {
		...
		if (!file.exists()) {
			...
			builder.append("二维码LOGO文件不存在，LogoPath：").append(logoPath).append("！");
	...
	public  static void encode(String content, String logoPath, File destFile, boolean needCompress) throws IOException, WriterException {
		BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
		ImageIO.write(image, FORMAT_NAME, destFile);
	}
	public static void encode(String content,  File destFile, boolean needCompress) throws IOException, WriterException {
	...
	public static void encode(String content, String logoPath, OutputStream output, boolean needCompress) throws IOException, WriterException
			 {
		BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
