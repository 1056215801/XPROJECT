...
import com.chinatelecom.jx.zone.management.weixin.vo.AjaxResult;
import com.chinatelecom.jx.zone.management.weixin.vo.PayAttach;
...
//		System.out.println("支付通知="+xmlMsg);
		...
		Order order = null ;//Order.dao.getOrderByTransactionId(transaction_id);
		if (order==null) {
